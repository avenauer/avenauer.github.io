...
const NftImages = () => {
  return (
    <>
      <ImageWrapper className="left-1/2 h-3/5" mask="dice" range={[0, 11000, -200, 1500]}>
        <Picture className="" src={NFTDice.nft1} alt="Budopoint category" />
      </ImageWrapper>
      <ImageWrapper className="bottom-1/2 h-3/5" mask="dice" range={[0, 11000, -200, 1500]}>
        <Picture className="" src={NFTDice.nft2} alt="Budopoint category" />
      </ImageWrapper>
      <ImageWrapper className="h-3/5" mask="dice" range={[0, 11000, -200, 1500]}>
        <Picture className="" src={NFTDice.nft3} alt="Budopoint category" />
      </ImageWrapper>
      <ImageWrapper className="left-1/3 h-3/5" mask="iphone" range={[0, 11000, -200, 1500]}>
